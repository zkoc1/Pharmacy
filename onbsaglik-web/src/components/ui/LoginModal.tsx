      ...
      <div className="bg-white rounded-3xl max-w-md w-full p-8 relative shadow-2xl overflow-hidden">
        ...
        {mode === 2 && (
          <form onSubmit={handleSendOtp} className="space-y-4">
            <p className="text-xs text-gray-600 mb-4 leading-relaxed">
              Kayıtlı e-posta adresinizi girin. Size şifrenizi sıfırlamanız için bir kod göndereceğiz.
            </p>
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1">E-posta</label>
              <input
        ...
        {mode === 3 && (
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            <p className="text-xs text-gray-600 mb-4 leading-relaxed">
              <strong className="text-gray-900">{email}</strong> adresine bir doğrulama kodu gönderdik. Lütfen kodu aşağıya girin.
            </p>
            <div>
